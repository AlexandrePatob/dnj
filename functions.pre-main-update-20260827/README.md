...
Required runtime configuration for the notification Function (T12) will be
provided through Firebase Secret Manager. The targeted push endpoint and its
authentication secret remain blocked until the official `dnj-game-api`
contract is verified (T13); no broadcast endpoint is permitted.
