 ...
 * revision: d5bcd8a94ebf
 */
var revision = "d5bcd8a94ebf";
(() => {
  ...
  function classifyRequest(request, appOrigin) {
    ...
    if (request.method !== "GET" || url.origin !== appOrigin || request.headers.has("Authorization") || url.pathname === "/v1" || url.pathname.startsWith("/v1/")) {
      return "network-only";
    }
  ...
  if (typeof scope.addEventListener === "function" && typeof scope.skipWaiting === "function" && scope.caches) {
    const revision = true ? "d5bcd8a94ebf" : "development";
