...
const csrfToken = () => typeof document === "undefined" ? undefined : document.cookie.split(";").map((x) => x.trim()).find((x) => x.startsWith("csrf_token="))?.slice(11);
