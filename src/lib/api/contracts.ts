...
export interface IdentitySessionResponse { accessToken: string; tokenType: "Bearer"; expiresIn: number; refreshToken: string; refreshExpiresIn: number; user: IdentityUser; onboardingRequired: boolean }
