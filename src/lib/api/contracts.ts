...
export interface IdentityUser { id: string; email: string; name: string; avatarUrl?: string | null; mobilePhone: string; documentMasked: string; role: ApiUserRole; group: { id: string; groupName?: string; name?: string } | null; onboardingComplete: boolean }
