...
export const gameApi = {
  ...
  validateQr: (qrToken: string, idempotencyKey = newIdempotencyKey()) => apiMutation<{ participation: V2Participation; action?: "joined" | "scored"; pointsAwarded?: number }>("/qr/validate", { method: "POST", body: { qrToken }, idempotencyKey }),
};
